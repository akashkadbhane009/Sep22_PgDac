...
public class  AccountOops{
	public static void main(String[] args){
		...
		m1.addSaving(123456,"Abhijeet ",234567.50);
		m1.addSaving(123457,"Akash ",234457.);
		m1.addSaving(123458,"Aditya ",233467);
		m1.addCurrent(123459,"Abhijeet ",23454.90);
		m1.addCurrent(123460,"Akash k",2723);
...
Account holder name is: Akash k
